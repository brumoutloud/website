...
exports.handler = async function (event, context) {
    ...
    try {
        ...
        const prompt = `
            ...
            Return the data as a JSON array of objects. Each object represents a single event and should have the following keys: "name", "venue", "date" (in YYYY-MM-DD format), "time" (in HH:MM 24-hour format), and "description".
            If there are multiple distinct events on the poster, return multiple objects in the array.
        `;
